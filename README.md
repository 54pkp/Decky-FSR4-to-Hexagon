...
研究日期：**2026-09-20**。用户指定设备为 Odin 3、骁龙 8 Elite，系统填写为“Amrda OS”；本文暂按 **Armada OS** 理解，具体镜像、内核、Steam/Proton 版本和首个游戏待核验。官方设备表将 Odin 3 列为 SM8750；设备树也包含 CQ8725S 标识。系统支持设备不等于 QNN/FSR4 已可用。[S5][S5a]
