...
- R04/R05 harden M0 evidence reads and whole-bundle public redaction: input is bound to the opened object and failures expose no partial bundle. This is Windows host-tool evidence only.
