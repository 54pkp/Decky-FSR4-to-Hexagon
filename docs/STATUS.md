...
下一批：**R06d——规范P6缺失输出父目录的稳定诊断。**

| 队列 | 当前实现状态 | 选择条件 |
| --- | --- | --- |
| R：审计修复、可复现性与回归 | R01–R06c `complete`；其余叶子项 `not_started` | 当前优先；R06d起，独立项可按依赖选择 |
...
最近记录：[R06c P6环境收据与漂移拒绝](validation/host/2026-09-22-r06c-p6-environment-receipt.md)；前一批：[R06b P6固定SDK私有快照](validation/host/2026-09-22-r06b-p6-sdk-snapshot.md)。
