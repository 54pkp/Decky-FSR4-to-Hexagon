...
下一批：**R03——严格解析P6 encoding，拒绝非整数bitwidth和非法布尔表示。**

| 队列 | 当前实现状态 | 选择条件 |
| --- | --- | --- |
| R：审计修复、可复现性与回归 | R01–R02 `complete`；其余叶子项 `not_started` | 当前优先；R03起，独立项可按依赖选择 |
...
最近记录：[R02 P6私有发布staging](validation/host/2026-09-22-r02-p6-private-publishing.md)；前一批：[R01 P5导出目录所有权修复](validation/host/2026-09-22-r01-p5-export-ownership.md)。
